...
class LenSliderSkins extends LenSlider {
    ...
    protected static $_presetSkins = array(
        'dares_serpent', 'smart_energy', 'vania_fit'
    );
    ...
    protected static function _lenslider_skins_abspath() {
        return WP_PLUGIN_DIR."/".parent::$_pluginName."/".self::$_skinsCatalog;
    }
    ...
    protected static function _lenslider_skins_httppath() {
        return WP_PLUGIN_URL."/".parent::$_pluginName."/".self::$_skinsCatalog;
    }
    ...
    protected static function _lenslider_skin_exists($skin_name, $path_to_skins_folder = false, $path_to_custom_skins_folder = false) {
        if(!$path_to_skins_folder) $path_to_skins_folder = self::_lenslider_skins_abspath();
        if(!$path_to_custom_skins_folder) $path_to_custom_skins_folder = self::_lenslider_skins_custom_abspath();
    ...
    public static function lenslider_get_skin_params_object($skin_name) {
        if(self::lenslider_is_skin($skin_name)) {
            ...
            if($skin_name != LenSlider::$defaultSkin) {
                ...
                $retObj->cssFiles = array(strtolower(WP_PLUGIN_DIR."/".parent::$_pluginName)."/css/defaultskin.css");
                $retObj->jsFiles  = array(strtolower(WP_PLUGIN_DIR."/".parent::$_pluginName)."/js/default-skin-custom.js");
            }
            return $retObj;
        }
    }
    ...
    public static function lenslider_delete_skin($skin_name) {
        if(!in_array($skin_name, parent::lenslider_get_enabled_skins_array_names())) {
